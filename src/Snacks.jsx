...
function Snacks() {
  ...
  const {
    ...
    error,
    fetchProducts
  } = useProducts("https://manomercy-supermarket.onrender.com/api/v1/snacks_products");
  ...
  const categoriesMap = {
    Snacks: ["All", "Chips", "Biscuit", "Drinks", "Other"],
  };
  ...
  return (
    <div className="snacks-user-container">
      {/* Loading State */}
      {isLoading && (
        <div className="page-loading products-loading">
          <i className="fas fa-cookie-bite fa-spin"></i>
          <h3>Loading Snacks</h3>
          <p>Getting delicious snacks for you...</p>
        </div>
      )}
      ...
      {!isLoading && !error && (
        <>
          {/* ================= Title Bar ================= */}
          <div className="snacks-user-title-bar">
            <div className="title-left">
              <h1>ManoMercy Supermarket</h1>
            </div>
            <div className="title-center">
              <div className="snacks-user-title-bar-search-bar">
          ...
          {/* ================= Subcategory Tabs ================= */}
          <div className="snacks-user-tabs">
          ...
          {/* ================= Product List ================= */}
          <div className={`snacks-user-list ${filteredProducts.length <= 3 ? "center-cards" : ""}`}>
            {filteredProducts.length === 0 ? (
              ...
              filteredProducts.map((p) => {
                ...
                return (
                  <div
                    className={`snacks-user-card ${outOfStock ? 'out-of-stock' : ''}`}
                    key={p._id}
                  >
                    <ProductImage
                        image={product.image}
                    ...
                    <div className="snacks-user-actions">
                      <button 
          ...
          {showPopup && selectedProduct && (
            <div className="snacks-user-modal">
              <div className="snacks-user-modal-content">
                <span 
                  className="snacks-user-close" 
