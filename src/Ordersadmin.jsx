...
const OrdersAdmin = () => {
  ...
  const fetchOrders = async () => {
    try {
      setIsLoading(true);
      setError("");
      const res = await fetch("https://manomercy-supermarket.onrender.com/api/v1/admin/orders", {
  ...
  const updateStatus = async (orderId, newStatus) => {
    try {
      const res = await fetch(`https://manomercy-supermarket.onrender.com/api/admin/orders/${orderId}`, {
        method: "PUT",
        headers: {
