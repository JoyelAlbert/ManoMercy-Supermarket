...
function Beauty() {
  ...
  const getOrCreateDraftOrder = async (token) => {
    try {
      ...
      const ordersRes = await fetch("https://manomercy-supermarket.onrender.com/api/orders", {
        headers: { 
      ...
      const createRes = await fetch("https://manomercy-supermarket.onrender.com/api/orders/draft", {
        method: "POST",
        headers: { 
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json"
