...
function Grocery() {
  ...
  const categoriesMap = {
    grossory: ["All", "Rice", "Oil", "Spices", "Flour", "Dhal"],
  };
  ...
  // Filter products by search + subcategory
  ...
  return (
    <div className="grossory-user-container">
      {/* Loading State */}
      {isLoading && (
      ...
      {!isLoading && !error && (
        <>
          {/* Title Bar */}
          <div className="grossory-user-title-bar">
            <div className="title-left">
              <h1>ManoMercy Supermarket</h1>
            </div>

            <div className="title-center">
              <div className="grossory-user-title-bar-search-bar">
          ...
          {/* Subcategory Tabs */}
          <div className="grossory-user-tabs">
          ...
          {/* Product List */}
          <div className={`grossory-user-list ${filteredProducts.length <= 3 ? "center-cards" : ""}`}>
            {filteredProducts.length === 0 ? (
              ...
              filteredProducts.map((p) => {
                ...
                return (
                  <div
                    className={`grossory-user-card ${outOfStock ? 'out-of-stock' : ''}`}
                    key={p._id}
                  >
                    <ProductImage
                      image={p.image}
                    ...
                    <div className="grossory-user-actions">
                      <button 
          ...
          {showPopup && selectedProduct && (
            <div className="grossory-user-modal">
              <div className="grossory-user-modal-content">
                <span 
                  className="grossory-user-close" 
