...
export default function Loginin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const endpoint = isSignup
        ? "https://manomercy-supermarket.onrender.com/api/v1/signup"
        : "https://manomercy-supermarket.onrender.com/api/v1/login";
  ...
  const handleForgotPassword = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://manomercy-supermarket.onrender.com/api/v1/forgot-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleVerifyCode = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://manomercy-supermarket.onrender.com/api/v1/verify-code", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handlePasswordReset = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://manomercy-supermarket.onrender.com/api/v1/reset-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
