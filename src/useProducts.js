...
function useProducts(baseUrl) {
  ...
  grossory_products: defaultGroceryProducts,
  snacks_products: defaultSnacksProducts,
  soap_products: defaultSoapProducts,
  beauty_products: defaultBeautyProducts,
};

const getFallbackProducts = () => {
  if (baseUrl.includes("grossory_products")) {
    return defaultGroceryProducts;
  }

  if (baseUrl.includes("snacks_products")) {
    return defaultSnacksProducts;
  }

  if (baseUrl.includes("soap_products")) {
    return defaultSoapProducts;
  }

  if (baseUrl.includes("beauty_products")) {
    return defaultBeautyProducts;
  }
