...
function Beautyadmin() {
  ...
  const [activeTab, setActiveTab] = useState("beauty_admin");
  ...
  const {
    ...
    toggleHomeProduct,
    homeProducts
  } = useProducts("https://manomercy-supermarket.onrender.com/api/v1/beauty_products");
  ...
  const beautySubcategories = ["Facewash", "Creams", "Lotions", "Shampoo", "Soap", "Other"];
    ...
    <div className="beauty-home-container">
      ...
      {isLoading && (
        <div className="page-loading admin-loading">
          ...
          <p>Managing your beauty products...</p>
        </div>
      )}

      {/* Title Bar */}
      <div className="beauty-home-title-bar">
        <div className="title-left">
          <h1>Beauty Products Admin</h1>
          <p>Total Products: {allProducts.length} | Home Products: {homeProducts.length}/8</p>
        </div>
        <div className="title-center">
          <div className="beauty-home-title-bar-search-bar">
      ...
      {/* Category Tabs */}
      <div className="beauty-home-tabs">
        {categories.map((cat) => (
          <button
            key={cat.key}
            onClick={() => {
      ...
      {/* Product List */}
      <div className="beauty-home-list">
        {filteredProducts.length === 0 ? (
          ...
          filteredProducts.map((p) => (
            <div className={`beauty-home-card ${!p.inStock ? "out-of-stock" : ""}`} key={p._id}>
              ...
              <div className="beauty-home-card-content">
                <h2>{p.name}</h2>
              ...
              <div className="beauty-home-actions">
                <button 
                  className="edit" 
      ...
      {/* Modal */}
      {showModal && (
        <div className="beauty-home-modal" onClick={() => setShowModal(false)}>
          <div className="beauty-home-modal-content" onClick={(e) => e.stopPropagation()}>
            <span 
              className="beauty-home-close" 
              onClick={() => setShowModal(false)}
            >
              &times;
            </span>
            
            <h2>{editId ? "Edit Beauty Product" : "Add New Beauty Product"}</h2>
